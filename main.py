...
This app will take in your resume, and a job posting link. Once it has both, it will take about 1 minute to generate a customized resume downloadable in Word format. You will see the words **"Download Analysis as Word Document"** once complete.

Please upload your resume using the file uploader below:
""")

cv_content=None
joblink=None

add_sidebar=st.sidebar.selectbox('Upload PDF Resume or Paste Text Resume',('Upload PDF Resume','Paste as text'))
if add_sidebar=='Paste as text':
     resume=st.text_input('Paste your Resume')
     st.write("Please upload your resume in PDF format.")

if add_sidebar=='Upload PDF Resume':
...
if cv_content and joblink:
    st.write('Resume & Job Uploaded, Generating Resume')
